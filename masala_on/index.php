...
<header class="header">
   ...
   <a class="logo"><img src="img/logo2.png" alt="logo"></a>
        ...
        <div  class="col-md-12 text-center">
            <button id="rb1" type="button" onclick="window.location.href='reservation.php'" class="btn btn-outline-light btn-lg"><em>Make a Reservation Now!</em></button>
        </div>
    </div>
</header>
...
<section id="aboutus">
 ...
 <div class="container">
   <h3 class="text-center"><br><br>Masala On</h3>
   <div class="row">
<!--carousel-->
...
<!--end of carousel-->
	...
	<p><br>The Masala On, first opened in 2018 at Shyamoli in Dhaka. In 2019 , the restaurant was awarded its first Michelin star and has retained it since.<br><br>
	The same year, the restaurant relocated to the 6th floor of the Basundhara city and was recently redesigned by award-winning architectural firm Divercity.In warmer months of the year the restaurant moves to the 7th floor of the building, offering a unique outdoor setting with panoramic view of the Acropolis, Lycebettus hill and the city skyline.<br><br><br></p><hr>
	</div>
     </div>
    </div><br>
  </div>
...
<div class="container" id="reservation">
    ...
    <button id="reserve-btn" type="button" onclick="window.location.href='reservation.php'" class="btn btn-outline-dark btn-block btn-lg">Make a reservation Now!</button>
...
<section class="map" id="footer">
    ...
    <h3 class="text-center"><br><br>Find us!</h3><br>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4342.848718056367!2d90.38772819695848!3d23.751447223641865!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8bcd681372b%3A0x5c2b8755e4327004!2sBashundhara%20City%20Shopping%20Complex!5e0!3m2!1sen!2sbd!4v1608760308308!5m2!1sen!2sbd" style= "width:100%;  height:250px; border:0;" allowfullscreen></iframe>
...
?>
            ...
            <p class="text-right"><strong>Masala On</strong><br><i class="fa fa-map-marker"></i>&nbsp; Basundhara Shopping complex, <br>Kawranbazar<br><br>Email:masalaon@diu.edu.bd<br>Phone: +880 1000 000 456</p>
            </div>
